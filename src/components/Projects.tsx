...
const projectsData: Project[] = [
  ...
  {
    id: 4,
    title: 'AI 數據分析平台（工廠版 Claude Code）',
    period: '2026/06 – 進行中',
    category: 'Agent & KG',
    description: '偏光片產線的地端 AI Agent 平台：感測器數據分析、知識沉澱與知識圖譜，Skill 格式與 Claude Code 相容，資料不出內網。',
    metric: '10 個 Docker 服務 · 7 種分析方法 · XGBoost F1 0.74',
    technologies: ['FastAPI', 'Gemini Function Calling', 'MCP', 'PostgreSQL + pgvector', 'Neo4j', 'Docker', 'React', 'XGBoost', 'SHAP'],
    highlights: [
      '原生 Skill / Bash / Read 工具 + 沙盒執行 + append-only 稽核日誌',
      '6 支 n8n 生產流程遷移為 1 個 skill（boxplot / SPC / importance / KDE …）+ 7 個 flows',
      '良率影響因子模型：50 支感測器、SHAP 配方建議卡與安全區間',
      '分析結果標註 → 與武功秘笈比對 → 知識圖譜（141 個實體已入圖）',
    ],
  },
  {
    id: 5,
    title: '企業大腦 PoC：知識圖譜 + Agent Harness',
    period: '2025/12 – 2026/05',
    category: 'Agent & KG',
    description: '以化妝品法規合規為案例建構公司知識圖譜，並自建 Claude Code 式 Agent 框架，為企業大腦奠定基礎。',
    metric: '2 個 PoC · 5 個子系統',
    technologies: ['Neo4j', 'PostgreSQL', 'Qdrant', 'Gemini API', 'FastAPI', 'GraphQL'],
    highlights: [
      '知識圖譜輸入規範 + 知識審核機制，避免錯誤知識污染',
      '法規版本控管與查詢 log，提供可追溯的 reference',
      'Agent 框架：Memory / Tool / Sandbox / Cronjob 五大子系統',
      'Prompt 版本控制與治理，每次 LLM 呼叫可追溯',
    ],
  },
  {
    id: 6,
